...
#This script computes per‑feature zonal means of the normalised TBDeff rasters
#(3, 7, 19, 37 GHz)
...
#These aggregated values are used to populate Table 1 and to generate the ROI
#plots in Figure 2 (see Section 3.8 of the manuscript).
